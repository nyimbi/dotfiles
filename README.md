...
##Some Changes I have made to the mathiasbynens dotfiles
- added a .extra file to hold my custom configs for all my macs
- I use macports. not homebrew
- It seems generally necessary to setup LC_ALL, LC_LANG, LC_LANGUAGE on remote servers
...
When setting up a new Mac, you may want to install some useful ports (Comment out the math stuff if that is not your thing)
```bash
./ports.sh
```
